...
public class Jewellery_chitfund {
	...
	private void method1() {
	    ...
	    System.out.println("*********************************");
	    System.out.println("Invesment to Bank or Gold");
	    System.out.println("Choose your option: Press 1.Bank\t Press 2.Gold");
	    int opt=sc.nextInt();
	    if(opt==1)
	    {
	    	...
	    	System.out.println("Yearly interest for your amount: 6%");
	    	int interestvalue=deposit*6/100;
	    	System.out.println("Interset value is: "+interestvalue);
...
for(int i=0;i<5;i++)		
		 ...
		 case 1:
			 ...
			 System.out.println("Total gram for chitfund amount "+gramcount);
			 int GST=total*3/100;
		 ...
		 case 2:
			 ...
			 System.out.println("Total gram for chitfund amount "+gram1);
		 ...
		 case 3:
			 ...
			 System.out.println("Total gram for chitfund amount "+gram2);
		 ...
		 case 4:
			 ...
			 System.out.println("Total gram for chitfund amount "+gram3);
